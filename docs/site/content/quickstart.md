...
В командах, которые принимают ник игрока, нажмите <kbd>Tab</kbd>, чтобы выбрать игрока из списка онлайн. Это работает, в частности, для личных сообщений (`/me <игрок> <сообщение>`, `/msg`, `/pm`), телепортации, модерации, почты, домов, магазинов и служебных команд.

Подсказки содержат только игроков онлайн. Если команда поддерживает офлайн-цели, например `/seen`, `/tpoffline` или историю наказаний, известный ник офлайн-игрока всё так же можно ввести вручную.
